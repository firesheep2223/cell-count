...
masks_pred, flows, styles, diams = model.eval(image_list, diameter=10, channels=[0,0],
                                              niter=2000) # 對細菌影像使用更多迭代


# predict_img(image_list, masks_pred)  # 在此替換為你的預測遮罩

cell_areas = calculate_cell_areas_from_masks(masks_pred,image_list, pixel_size=10, visualize=False)
